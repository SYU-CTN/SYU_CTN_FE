...
const DEFAULT_LAYOUT_OVERRIDE = {
    // 1학년 1학기
    1:  { row: 0 }, // C01 소프트웨어원리
    34: { row: 1 }, // E01 AI를 위한 미적분학

    // 1학년 2학기
    18: { row: 0 }, // S01 UX프로그래밍
    35: { row: 1 }, // E02 AI를 위한 이산수학
    36: { row: 2 }, // E03 AIoT프로그래밍

    // 2학년 1학기
    2:  { row: 0 }, // C02 컴퓨터프로그래밍
    4:  { row: 1 }, // C04 자료구조
    6:  { row: 2 }, // C06 오픈소스SW이해와활용
    8:  { row: 3 }, // C08 창의적공학설계
    9:  { row: 4 }, // C09 확률통계
    19: { row: 5 }, // S02 객체지향프로그래밍I
    37: { row: 6 }, // E04 디지털논리회로

    // 2학년 2학기
    3:  { row: 0 }, // C03 컴퓨터프로그래밍응용
    7:  { row: 1 }, // C07 AI응용 윈도우프로그래밍
    10: { row: 2 }, // C10 선형대수
    20: { row: 3 }, // S03 객체지향프로그래밍II
    21: { row: 4 }, // S04 웹프로그래밍
    38: { row: 5 }, // E05 컴퓨터구조
    39: { row: 6 }, // E06 데이터통신
    ...
    // 3학년 1학기
    5:  { row: 0 }, // C05 컴퓨터알고리즘
    22: { row: 1 }, // S05 프로그래밍언어론
    24: { row: 2 }, // S07 모바일프로그래밍
    25: { row: 3 }, // S08 인공지능
    30: { row: 4 }, // S13 데이터베이스
    40: { row: 5 }, // E07 운영체제
    45: { row: 6 }, // E12 컴퓨터네트워크
    49: { row: 7 }, // E16 시스템프로그래밍
    50: { row: 8 }, // E17 AI를 위한 클라우드 컴퓨팅
    51: { row: 9 }, // E18 멀티미디어

    // 3학년 2학기
    11: { row: 0 }, // C11 산학협력캡스톤디자인I
    17: { row: 1 }, // C17 ICT멘토링프로젝트
    23: { row: 2 }, // S06 컴파일러
    28: { row: 3 }, // S11 소프트웨어공학
    31: { row: 4 }, // S14 데이터베이스 프로그래밍
    41: { row: 5 }, // E08 리눅스시스템
    46: { row: 6 }, // E13 네트워크 프로그래밍
    52: { row: 7 }, // E19 디지털영상처리

    // 4학년 1학기
    12: { row: 0 }, // C12 산학협력캡스톤디자인II
    15: { row: 1 }, // C15 기업가정신과창업
    26: { row: 2 }, // S09 기계학습
    29: { row: 3 }, // S12 소프트웨어 디자인 패턴
    32: { row: 4 }, // S15 AI를 위한 빅데이터 처리
    42: { row: 5 }, // E09 AI 임베디드시스템
    47: { row: 6 }, // E14 모바일네트워크
    53: { row: 7 }, // E20 컴퓨터그래픽스

    // 4학년 2학기
    13: { row: 0 }, // C13 산학협력캡스톤디자인III
    14: { row: 1 }, // C14 종합시험(P)
    16: { row: 2 }, // C16 ICT인턴십
    27: { row: 3 }, // S10 AI를 위한 인간컴퓨터 상호작용
    33: { row: 4 }, // S16 AI를 위한 빅데이터 분석 및 표현
    43: { row: 5 }, // E10 실시간운영체제
    44: { row: 6 }, // E11 AIoT프로그래밍II
    48: { row: 7 }, // E15 네트워크엔지니어링
    54: { row: 8 }, // E21 정보보호및보안
};
